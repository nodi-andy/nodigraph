...
const PADDING = 40;
// Rendered at native 1:1 so text/port sizing matches the canvas, and
// CROPPED TO CONTENT rather than squeezed into a fixed frame. Only scaled
// down (never up) when a diagram is big enough that 1:1 would produce an
